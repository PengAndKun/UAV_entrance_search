...
def default_validation_paths(output_root: Path | str = Path("obstacle_representation_3_data")) -> Dict[str, Path]:
    ...
    return {
        ...
        "report": root / "validation" / "a_plus_3_4_validation_report.json",
    }


def validate_model_3_4(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate Obstacle Representation 3.4 model.")
