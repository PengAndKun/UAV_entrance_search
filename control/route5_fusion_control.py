...
class Route5FusionControlMixin(Route7PlanningMixin, Route7MapWindowMixin):
    ...
    def route5_plan_repair_pose(
        ...
        *,
        ...
        target_z = float(corridor.get("max_z_cm", (target_pose if isinstance(target_pose, dict) else {}).get("z", 300.0)) or 300.0)
