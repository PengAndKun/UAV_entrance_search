...
DEFAULT_ROUTE6_FIXED_WORLD_BOUNDS_CM = {"min_x": -6000, "max_x": 6000, "min_y": -6000, "max_y": 6000}
...
def _normalize_fixed_world_bounds_cm(bounds: Optional[Dict[str, Any]]) -> Optional[Dict[str, int]]:
    if not isinstance(bounds, dict):
        return None
    result = {
        "min_x": _as_int(bounds.get("min_x"), -6000),
        "max_x": _as_int(bounds.get("max_x"), 6000),
        "min_y": _as_int(bounds.get("min_y"), -6000),
        "max_y": _as_int(bounds.get("max_y"), 6000),
    }
