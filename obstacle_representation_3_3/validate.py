...
def default_validation_paths(output_root: Path | str = Path("obstacle_representation_3_data")) -> Dict[str, Path]:
    ...
    return {
        ...
        "report": root / "validation" / "a_plus_3_3_validation_report.json",
    }


def validate_model_3_3(
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate Obstacle Representation 3.3 model.")
