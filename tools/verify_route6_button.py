...
def test_route6_mixin_contract() -> None:
    ...
    for method_name in (
        ...
        "route6_capture_direction_sweep",
        "route6_build_visual_direction_context",
        "route6_call_visual_house_llm",
        "route6_select_visual_house_target",
        "route6_mark_visual_house_candidate_on_map",
        "route6_build_visual_marker_overlay",
        "route6_detect_height_conflict",
        "route6_decide_height_conflict_avoidance",
        "route6_call_replan_llm",
        "route6_plan_building_orbit_capture",
        "route6_execute_building_orbit_capture",
        "route6_should_capture_map_after_motion",
...
def test_route6_window_declares_design_doc_and_core_controls() -> None:
    ...
    for label in (
        ...
        "Refresh OR",
        "LLM Map Analysis",
        "LLM Visual Direction Analysis",
        "Capture Direction Sweep",
        "Analyze Direction Images",
        "Apply Visual House Marker",
        "Start Visual Target Approach",
        "Height Conflict / Replan",
